...
export class MwcList extends st.component<IMwcListAttrs> implements ILifecycle {
    ...
    onAfterElCreate() {
        if (this.twoLine) {
            this.el.classList.add("mdc-list--two-line");
        }

        if (this.nonInteractive) {
            this.el.classList.add("mdc-list--non-interactive");
        }

        if (this.dense) {
            this.el.classList.add("mdc-list--dense");
        }

        if (this.avatarList) {
            this.el.classList.add("mdc-list--avatar-list");
        }
    }
