...
/*
 * Material Icon: contact_phone filled
 * version: V1
 * categories: communication
 * tags: contact, info, information, number, person, phone, profile
 * download link: https://fonts.gstatic.com/s/i/materialicons/contact_phone/v1/24px.svg
 */
export const mwcIconContactPhoneFilled = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="material-icon">
      <path d="M0 0h24v24H0z" fill="none"/>
      <path d="M22 3H2C.9 3 0 3.9 0 5v14c0 1.1.9 2 2 2h20c1.1 0 1.99-.9 1.99-2L24 5c0-1.1-.9-2-2-2zM8 6c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm6 12H2v-1c0-2 4-3.1 6-3.1s6 1.1 6 3.1v1zm3.85-4h1.64L21 16l-1.99 1.99c-1.31-.98-2.28-2.38-2.73-3.99-.18-.64-.28-1.31-.28-2s.1-1.36.28-2c.45-1.62 1.42-3.01 2.73-3.99L21 8l-1.51 2h-1.64c-.22.63-.35 1.3-.35 2s.13 1.37.35 2z" class="material-icon primary-color"/>
    </svg>
};

/*
 * Material Icon: contact_phone outlined
 * version: V1
 * categories: communication
 * tags: contact, info, information, number, person, phone, profile
 * download link: https://fonts.gstatic.com/s/i/materialiconsoutlined/contact_phone/v1/24px.svg
 */
export const mwcIconContactPhoneOutlined = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="material-icon">
...
/*
 * Material Icon: contact_phone two-tone
 * version: V1
 * categories: communication
 * tags: contact, info, information, number, person, phone, profile
 * download link: https://fonts.gstatic.com/s/i/materialiconstwotone/contact_phone/v1/24px.svg
 */
export const mwcIconContactPhoneTwoTone = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="material-icon">
      <path fill="none" d="M0 0h24v24H0V0z"/>
