...
/*
 * Material Icon: alarm_off two-tone
 * version: V1
 * categories: action
 * tags: alarm, clock, disabled, off, stop, time
 * download link: https://fonts.gstatic.com/s/i/materialiconstwotone/alarm_off/v1/24px.svg
 */
export const mwcIconAlarmOffTwoTone = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="material-icon">
      <path fill="none" d="M0 0h24v24H0V0z"/>
