          ...
          <MwcCard class={["card-size", cardPage.cardSize]}>
            <template slot={MwcCard.SLOT_NAME_PRIMARY}>
              ...
              <div class={contentClasses}>
                ...
                <MwcSubtitle1 class={noMarginClasses}>
                  <b>Our Motivation</b>
                </MwcSubtitle1>
                <MwcBody2 class={noMarginClasses}>
                  SpringType aims to be the web development framework with the most elegant API's and the greatest
                  developer experience. This is a stellar goal, but we believe that what we can achieve is only limited
                  by what we can imagine.
                </MwcBody2>
                <div style="height: 10px" />
                <MwcBody2 class={noMarginClasses}>
                  From 50 years of experience (combined) we learned that all systems of high complexity fail in major
                  aspects. The more a system grows in complexity...
                </MwcBody2>
              </div>
            </template>
            <template slot={MwcCard.SLOT_NAME_ACTION}>
              <div class="mdc-card__action-buttons">
                <a
                  href="http://github.com/springtype-org"
