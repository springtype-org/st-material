  ...
  render() {
    return (
      <div>
        ...
        <MwcList class={listPageStyle.demoList}>
          <MwcListItem>
            <MwcListItemIcon type="wifi"></MwcListItemIcon>
            Single-line item
          </MwcListItem>

          <MwcListItem activated={true}>
            <MwcListItemIcon type="bluetooth"></MwcListItemIcon>
            Single-line item, activated
          </MwcListItem>

          <MwcListItem disabled={true}>
            <MwcListItemIcon type="data_usage"></MwcListItemIcon>
        ...
        <MwcList class={listPageStyle.demoList} singleSelection={true}>
          ...
          <MwcListItem activated={true}>
            <MwcListItemIcon type="star"></MwcListItemIcon>
            Single-line item, activated
          </MwcListItem>
        ...
        <MwcList class={listPageStyle.demoList} singleSelection={true}>
          <MwcListItem class={listPageStyle.demoListItemShaped}>
            <MwcListItemIcon type="wifi"></MwcListItemIcon>
            Single-line item
          </MwcListItem>

          <MwcListItem activated={true} class={listPageStyle.demoListItemShaped}>
            <MwcListItemIcon type="star"></MwcListItemIcon>
            Single-line item, activated
          </MwcListItem>

          <MwcListItem disabled={true} class={listPageStyle.demoListItemShaped}>
            <MwcListItemIcon type="send"></MwcListItemIcon>
            Single-line item, disabled
          </MwcListItem>
