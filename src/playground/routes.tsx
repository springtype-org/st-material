import { PATH_DEFAULT, PATH_WILDCARD, RouteList, Route } from "springtype/web/router";
...
export const ROUTES = (
  <RouteList>
    <Route
      path={[PATH_DEFAULT, PATH_WILDCARD, CheckboxPage.ROUTE]}
      component={
        <HomePageContainer>
          <CheckboxPage />
        </HomePageContainer>
